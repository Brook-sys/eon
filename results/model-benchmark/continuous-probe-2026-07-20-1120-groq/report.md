...
- Kind: `live`
- Verdict: `PASS`
- Headline: Cognitive baseline PASS for model "llama-3.3-70b-versatile" on "cognitive-tool-v1": correct=1/1 syntax_valid=1 (provider_errors=0 validation_errors=0).
...
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: |
| tool-search-single | SYNTHESIZE | JSON | 2048 | CORRECT | 0 | 0 ms | 165/18 | 350 ms |
