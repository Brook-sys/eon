...
- Kind: `live`
- Verdict: `FAIL`
- Headline: Cognitive baseline FAIL for model "meta/llama-3.1-8b-instruct" on "cognitive-tool-v1": correct=0/1 syntax_valid=0 (provider_errors=0 validation_errors=1).
...
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: |
| tool-search-single | SYNTHESIZE | JSON | 2048 | VALIDATION | 0 | 0 ms | 164/64 | 1093 ms |
