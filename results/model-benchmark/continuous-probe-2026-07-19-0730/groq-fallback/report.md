...
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: |
| extract-date | EXTRACT | CHOICE | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 92 ms |
| extract-date | EXTRACT | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 38 ms |
| extract-date | EXTRACT | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 32 ms |
| extract-qualified-date | EXTRACT | CHOICE | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 33 ms |
| extract-qualified-date | EXTRACT | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 36 ms |
| extract-qualified-date | EXTRACT | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 35 ms |
| synthesize-support | SYNTHESIZE | CHOICE | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 35 ms |
| synthesize-support | SYNTHESIZE | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 34 ms |
...
| synthesize-counterexample | SYNTHESIZE | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 34 ms |
| synthesize-counterexample | SYNTHESIZE | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 36 ms |
...
| detect-conflict | CONFLICT | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 32 ms |
| distinguish-temporal-change | CONFLICT | CHOICE | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 33 ms |
| distinguish-temporal-change | CONFLICT | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 35 ms |
| distinguish-temporal-change | CONFLICT | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 36 ms |
| repair-anchor | REPAIR | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 40 ms |
| repair-anchor | REPAIR | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 50 ms |
| repair-unrecoverable | REPAIR | DELIMITED | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 43 ms |
| repair-unrecoverable | REPAIR | JSON | 2048 | PROVIDER | 401 | 0 ms | 0/0 | 49 ms |
