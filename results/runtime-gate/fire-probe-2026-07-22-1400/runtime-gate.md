...
- Name: `nim-primary-circuit-to-groq-json-framing-rerun-2026-07-22-1400`
- External calls: 1/1
- Seeded circuit: `model-binding:nim-primary`
- Selected route: `groq` / `groq-fallback`
- Provider success: `true`
- Provider latency: `398.390952ms`
...
- Second acquire: `resource_resource_rate_limit` until `2026-07-22T17:04:00Z`
...
| model-binding:nim-primary | 0 | 0 | 0 | 0 | 1 | 2026-07-22T17:04:36Z |
