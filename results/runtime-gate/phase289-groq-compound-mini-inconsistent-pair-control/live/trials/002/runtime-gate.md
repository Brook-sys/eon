...
- Second acquire: `resource_resource_rate_limit` until `2026-07-28T00:03:00Z`
- Operation state after local throttle: `WAITING_TIME`
- Durable reopen verified: `true`

| Resource | In flight | Calls/min | Calls/day | Tokens/min | Failures | Circuit open until |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| model-binding:groq-compound-mini-live | 0 | 1 | 1 | 1079 | 0 |  |
| model-binding:nim-llama31-70b-seeded | 0 | 0 | 0 | 0 | 1 | 2026-07-28T00:03:44Z |
| model-provider:groq | 0 | 1 | 1 | 1079 | 0 |  |
