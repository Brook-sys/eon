...
- Second acquire: `resource_resource_rate_limit` until `2026-07-28T03:44:00Z`
- Operation state after local throttle: `WAITING_TIME`
- Durable reopen verified: `true`

| Resource | In flight | Calls/min | Calls/day | Tokens/min | Failures | Circuit open until |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| model-binding:groq-compound-mini | 0 | 1 | 1 | 1037 | 0 |  |
| model-binding:groq-compound-mini-seeded | 0 | 0 | 0 | 0 | 1 | 2026-07-28T03:44:21Z |
| model-provider:groq | 0 | 1 | 1 | 1037 | 0 |  |
