...
- [ ] `TODO` Criar um harness integrado ao `ModelExecutor` que injete uma primeira completion malformada e permita que as chamadas seguintes usem providers live, observando `SHORT_CORRECTION`, formato simples, fallback e esgotamento no mesmo fluxo persistido.
