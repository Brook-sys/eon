...
- [ ] `READY` Testar longevidade sem repouso, diversidade entre famílias, budgets e ausência de atividade sem delta.
  - Parcial: testes unitários de admission, fan-out, preventive replenish e rotação/despacho por família; falta cenário multi-ciclo de longevidade com contadores de diversidade/delta.
