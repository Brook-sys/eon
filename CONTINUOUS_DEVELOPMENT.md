...
- [ ] `IN_PROGRESS` Implementar gerador, runner medido e crash harness subprocessado para ambos os backends.
  ...
  - Restante: batching/amostras percentuais e footprint; worker CLI que encerra abruptamente nos hooks; Dolt medido via `sql-server`, distinguindo working set SQL de commit Dolt.
