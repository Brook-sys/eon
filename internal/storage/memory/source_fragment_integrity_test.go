...
func TestAppendSourceFragmentsRejectsCorruptFragmentsAndFailsAtomic(t *testing.T) {
	...
	// First attempt: valid fragment + corrupt fragment
	// Corrupt fragment has EndOffset == StartOffset which fails domain.SourceFragment.Validate()
	...
	// Verify atomicity: NO fragments should be persisted from the failed batch
	...
	// Second attempt: valid fragments should succeed completely
