...
func operationSpec() domain.OperationSpec {
	return domain.OperationSpec{SchemaVersion: 1, ID: "extract@1", ContractVersion: 1, InputSchema: "refs", OutputSchema: "proposal", Budget: domain.Budget{ModelCalls: 1, Tokens: 1000, Attempts: 1}, Validators: []string{"schema"}, RetryPolicy: "none", FallbackPolicy: "fail", MaximumAuthority: domain.AuthorityProposeOnly}
}
